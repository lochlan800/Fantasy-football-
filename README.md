...
- **🧩 Template team builder** — in **🧮 Squad Builder → ⚡ Auto-Pick**, the **🧩 Template**
  ...
  actual template players (weighted by ownership + rating **and each team's next-6-gameweek
  fixture run** — good runs and doubles rise, brutal runs and blanks fall, right down to
  the captain), keeps a legal 2·5·5·3 / max-3-per-club / ≤£100m squad with a cheap playing
  bench, and captains your best premium. It then shows a **🧩 Template make-up** card
